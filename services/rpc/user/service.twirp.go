...
func NewUserServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) UserService {
	...
	serviceURL += baseServicePath(pathPrefix, "rpc.user", "UserService")
	urls := [1]string{
		serviceURL + "GetUser",
	}
...
func (c *userServiceProtobufClient) GetUser(ctx context.Context, in *UserRequest) (*UserResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "rpc.user")
...
func (c *userServiceProtobufClient) callGetUser(ctx context.Context, in *UserRequest) (*UserResponse, error) {
...
func (c *userServiceJSONClient) GetUser(ctx context.Context, in *UserRequest) (*UserResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "rpc.user")
	ctx = ctxsetters.WithServiceName(ctx, "UserService")
	ctx = ctxsetters.WithMethodName(ctx, "GetUser")
	caller := c.callGetUser
...
func (c *userServiceJSONClient) callGetUser(ctx context.Context, in *UserRequest) (*UserResponse, error) {
	out := new(UserResponse)
...
const UserServicePathPrefix = "/twirp/rpc.user.UserService/"
...
func (s *userServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "rpc.user.UserService" {
...
func (s *userServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "rpc.user", "UserService")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
