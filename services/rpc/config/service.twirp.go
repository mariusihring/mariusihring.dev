...
// source: rpc/config/service.proto
...
const ConfigServicePathPrefix = "/twirp/rpc.config.ConfigService/"

func (s *configServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "rpc.config")
	...
	if pkgService != "rpc.config.ConfigService" {
...
func (s *configServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "rpc.config", "ConfigService")
}
...
var twirpFileDescriptor0 = []byte{
	...
	0x4f, 0xce, 0xcf, 0x4b, 0xcb, 0x4c, 0xd7, 0x2f, 0x4e, 0x2d, 0x2a, 0xcb, 0x4c, 0x4e, 0xd5, 0x2b,
	0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x2a, 0x2a, 0x48, 0xd6, 0x83, 0xc8, 0x18, 0xf1, 0x73, 0xf1,
	0x3a, 0x83, 0x59, 0xc1, 0x10, 0x25, 0x4e, 0x3c, 0x51, 0x5c, 0x08, 0x8d, 0x49, 0x6c, 0x60, 0x1d,
	0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x58, 0x87, 0x4c, 0x34, 0x4d, 0x00, 0x00, 0x00,
}
